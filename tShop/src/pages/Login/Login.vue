    ...
    <div class="loginInner">
      <div class="login_header">
        ...
        <div class="login_header_title">
          <a href="javascript:;" :class="{on:isMessage}" @click="isMessage=true">短信登录</a>
          <a href="javascript:;" :class="{on:!isMessage}" @click="isMessage=false">密码登录</a>
        </div>
      </div>
      <div class="login_content">
        <form>
          <div :class="{on:isMessage}" >
            <section class="login_message">
              <input type="tel" maxlength="11" placeholder=" 手机号" v-model.trim="phoneNum">
          ...
          <div :class="{on:!isMessage}">
            <section>
              ...
              <section class="login_verification">
                <input type="text" maxlength="8" placeholder=" 密码" v-if="showPwd" v-model.trim="password">
                <input type="password" maxlength="8" placeholder=" 密码" v-else v-model.trim="password">
                <div class="switch_button" :class="showPwd?'on':'off'" @click="showPwd=!showPwd">
                  <div class="switch_circle " :class="showPwd?'right':'left'"></div>
                  <span class="switch_text">abc</span>
                </div>
              </section>
              <section class="login_message">
                <input type="text" maxlength="11" placeholder=" 验证码" v-model.trim="code">
        ...
        methods:{
            ...
            async login(){
                ...
                if (this.isMessage){
                    ...
                    const result=await reqPwdLogin({name,password,code})
                    if (result.code===0){
