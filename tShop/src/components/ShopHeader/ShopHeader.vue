<template>
  <div class="shop-header">
    ...
    <div @click="isShowDesc=!isShowDesc" class="shop-content">
...
{{info.description}}
<span>约 {{info.deliveryTime}}</span>
</span>
          <span class="shop-message-detail">距离 {{info.distance}}</span>
        </div>
      </div>
    </div>
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupport=!isShowSupport">
...
<span class="mini-tag">{{info.supports[0].name}}</span>
    ...
    <div v-if="isShowDesc" class="shop-brief-modal">
...
<span class="mini-tag">品牌</span>
        ...
        <div class="mask-footer" @click="isShowDesc=!isShowDesc">
